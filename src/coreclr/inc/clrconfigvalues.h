...
RETAIL_CONFIG_DWORD_INFO(INTERNAL_Thread_YieldsPerNormalizedYield, W("Thread_YieldsPerNormalizedYield"), (DWORD)-1, "Specifies the number of yields per normalized yield.")
RETAIL_CONFIG_DWORD_INFO(INTERNAL_Thread_YieldsPerSpinIteration, W("Thread_YieldsPerSpinIteration"), (DWORD)-1, "Specifies the number of yields per spin iteration.")
