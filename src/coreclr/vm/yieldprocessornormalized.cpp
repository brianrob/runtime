...
static void InitializeYieldProcessorNormalized()
{
    ...
    DWORD config_yieldsPerNormalizedYield = CLRConfig::GetConfigValue(CLRConfig::INTERNAL_Thread_YieldsPerNormalizedYield);
    DWORD config_optimalMaxNormalizedYieldsPerSpinIteration = CLRConfig::GetConfigValue(CLRConfig::INTERNAL_Thread_YieldsPerSpinIteration);

    int yieldsPerNormalizedYield = 0;
    int optimalMaxNormalizedYieldsPerSpinIteration = 0;
    if ((config_yieldsPerNormalizedYield == (DWORD)-1) && (config_optimalMaxNormalizedYieldsPerSpinIteration == (DWORD)-1))
    {
    ...
    yieldsPerNormalizedYield = (int)(MinNsPerNormalizedYield / nsPerYield + 0.5);
    ...
    {
        yieldsPerNormalizedYield = config_yieldsPerNormalizedYield;
        optimalMaxNormalizedYieldsPerSpinIteration = config_optimalMaxNormalizedYieldsPerSpinIteration;
    }
